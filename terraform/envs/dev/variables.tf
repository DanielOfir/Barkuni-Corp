...
variable "instance_types" {
  type        = list(string)
  description = "A list of instance types to launch the cluster in"
}
...
variable "kubernetes_labels" {
  type        = map(string)
  description = "A map of Kubernetes labels to add to the nodes"
  default     = {}
}
...
variable "kubernetes_alb_controller_enabled" {
  type        = bool
  description = "Set to true to enable the AWS Load Balancer Controller"
  default     = false
}